        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2.5">
            <div style={{ width: 32, height: 32, borderRadius: 10, background: "rgba(232,255,0,0.12)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <CreditCard style={{ width: 16, height: 16, color: "var(--sosa-yellow)" }} />
            </div>
            ...
            {transactions.map((tx, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p style={{ fontSize: 13, fontWeight: 700, letterSpacing: "-0.3px", flexShrink: 0, color: isIncome ? "var(--color-success)" : "var(--color-error)" }}>
