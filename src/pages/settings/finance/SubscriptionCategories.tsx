...
import {
  Monitor, Cloud, Palette, Megaphone, Cpu, MessageCircle, HardDrive, BarChart2, MoreHorizontal,
...
const ICON_OPTIONS = ["Monitor","Cloud","Palette","Megaphone","Cpu","MessageCircle","HardDrive","BarChart2","MoreHorizontal"] as const;
...
const emptyForm = (): FormState => ({
  name: "", icon: "Monitor", color: "#60A5FA", billing_cycle: "monthly", reminder_days: 3, is_active: true,
});
...
export default function SubscriptionCategories() {
  ...
  function openEdit(cat: SubscriptionCategory) {
    ...
    setForm({
      ...
      reminder_days: cat.reminder_days,
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
        <div>
          ...
          <p style={{ fontSize: 13, color: TEXT_SECONDARY, margin: "4px 0 0" }}>
            Classifica gli abbonamenti ricorrenti per tipologia
          </p>
        </div>
      ...
      <div style={{ background: BG_CARD, border: `0.5px solid ${BORDER}`, borderRadius: 12, padding: "18px 22px" }}>
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: "40px 0", color: TEXT_MUTED }}>
            <Monitor size={32} style={{ margin: "0 auto 10px", opacity: 0.3 }} />
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <span style={{ fontSize: 13, fontWeight: 500, color: TEXT_PRIMARY }}>{cat.name}</span>
                    </div>
                    <div style={{ fontSize: 11, color: TEXT_MUTED, marginTop: 2 }}>
                      Ciclo: {CYCLE_LABELS[cat.billing_cycle]} · Reminder: {cat.reminder_days}gg
                    </div>
                  </div>
          ...
          >
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <label style={labelStyle}>
                  <span style={labelText}>Ciclo rinnovo default</span>
                  <select className="glass-input" value={form.billing_cycle} onChange={e => setForm(f => ({ ...f, billing_cycle: e.target.value as BillingCycle }))}>
                ...
                <label style={labelStyle}>
                  <span style={labelText}>Reminder (giorni prima)</span>
                  <input className="glass-input" type="number" min={1} max={30} value={form.reminder_days}
